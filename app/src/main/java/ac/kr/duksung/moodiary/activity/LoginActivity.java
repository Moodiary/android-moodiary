        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(user_id.equals("")){
                    ...
                    JsonObjectRequest R_Object = new JsonObjectRequest(Request.Method.POST, "http://172.20.18.162:3000/user/login", requestJsonObject, new Response.Listener<JSONObject>() {
